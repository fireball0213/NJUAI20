...
class Config(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-mode', help='train/eval/cli', type=str,default='eval')#, required=True)
        parser.add_argument('-model_checkpoint', help='Huggingface Model Path', type=str
                            ,default='kevinscaria/atsc_tk-instruct-base-def-pos-neg-neut-combined')#, required=True
        ...
        parser.add_argument('-task', help='ate/atsc/joint', type=str,default='atsc')#
